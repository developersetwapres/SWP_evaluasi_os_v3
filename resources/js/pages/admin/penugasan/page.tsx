...
import type { PenugasanPeer } from '@/types/penugasan';
...
export default function PeerAssignment({
    ...
    const handleAssignEvaluators = () => {
        if (
            ...
            (selectedEvaluators.atasan ||
                selectedEvaluators.penerima_layanan1 ||
                selectedEvaluators.penerima_layanan2)
        ) {
    ...
    function hitungEvaluator(employees: PenugasanPeer[]) {
        ...
        for (const emp of employees) {
            ...
            if (
                ev.atasan?.name &&
                ev.penerima_layanan1?.name &&
                ev.penerima_layanan2?.name
            ) {
                sudah++;
            } else {
                belum++;
            ...
            <Card className="bg-linear-to-r from-indigo-500 to-purple-600 text-white">
                <CardHeader>
                    ...
                    <CardDescription className="text-indigo-100">
                        Tetapkan rekan kerja sebagai evaluator peer untuk setiap
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-3 pe-6">
                                        <div className="mb-1 flex items-center space-x-2">
                                            ...
                                            <Label className="text-sm font-medium text-gray-900">
                                                2. Evaluator Penerima Layanan 1
                                            </Label>
                                        </div>
                                        ...
                                        <div className="ml-7">
                                            <SearchableSelect
                                                ...
                                                placeholder="Cari dan pilih user 1 sebagai evaluator..."
                                                getLabel={(e) => e.name}
                                                getSubLabel={(e) =>
                                                    `${e.jabatan} • ${e.biro?.nama_biro || ''}`
                                                }
                                    ...
                                    <div className="space-y-3 pe-6">
                                        <div className="mb-1 flex items-center space-x-2">
                                            <Shield className="h-5 w-5 text-blue-600" />
                                            <Label className="text-sm font-medium text-gray-900">
                                                2. Evaluator Penerima Layanan 2
                                            </Label>
                                        </div>
                                        ...
                                        <div className="ml-7">
                                            <SearchableSelect
                                                ...
                                                placeholder="Cari dan pilih user 2 sebagai evaluator..."
                                                getLabel={(e) => e.name}
                                                getSubLabel={(e) =>
                                                    `${e.jabatan} • ${e.biro?.nama_biro || ''}`
                                                }
